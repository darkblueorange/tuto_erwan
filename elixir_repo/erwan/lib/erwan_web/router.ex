defmodule ErwanWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {ErwanWeb.Layouts, :root}
  ...
  # scope "/api", ErwanWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:erwan, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ErwanWeb.Telemetry
